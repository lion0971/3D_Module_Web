...
renderer.toneMappingExposure = 0.7; // 稍微調高，讓暖色調更亮眼
...
loader.load(CONFIG.MODELS.BUILDING, (gltf) => {
    ...
    gltf.scene.traverse((mesh) => {
        ...
        if (name.includes("bulb")) {
            ...
            // 實體 SpotLight (地面暖光投影)
            // 在 loader.load 內部巡檢 bulb 時
            const spotLight = new THREE.SpotLight(0xffaa44, 8, 15, Math.PI / 3.5, 0.6, 2); // 強度從 15 調降至 8
